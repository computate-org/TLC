...
def generate_routefile_Veberod_uni(file_name, run_time, lam1, lam2, fix_seed):
    seed = 3570926575676058649
    if not fix_seed:
        seed = random.randrange(sys.maxsize)
    random.seed(seed)
    ...
    next_42 = uniform_gen(lam42[0], lam42[1])
...
def generate_routefile_pedestrian_uni(file_name, run_time, lam1, lam2, fix_seed):
    ...
    next_w31 = uniform_gen(lam_w31[0], lam_w31[1])
    next_w42 = uniform_gen(lam_w42[0], lam_w42[1])
